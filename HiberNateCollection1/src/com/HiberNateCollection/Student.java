...
public class Student {
	...
	@CollectionTable(name = "myInterview", joinColumns = @JoinColumn(name = "sid"))
	 @OrderColumn (name = "InterviewOrder")
	...
	public Student(int sid, String sname, String semail, int sphone, String[] courses, List<String> skills,
			List<Integer> marks, Set<String> sinterview, Map<String, Integer> refs) {
		super();
		Sid = sid;
		Sname = sname;
		Semail = semail;
